...
###调研反馈：  
丁汀：可提供操作模式：无团队协作、有团队协作+个人学习计划,团队合作参考知米豆，完成任务可以用豆子买高级单词书类似     
尹昱程：UI设计要简洁，但是有深度，参考微信   
周琦：细化，侧重激励或者效率某一方面   
吴正涛：功能主次一定要分清；老师端推送任务形式单一，失去意义；   
郝帅：在任务期间解锁或是检测到打开其他软件，成就失败这类的惩罚比较有效；任务可以选择困难模式，多奖励，跟课程紧密结合，作业+笔记  
鲁文：邀请学霸答题，在图书馆或者自习室（社交）

###补充：
2015/12/24 牛严补充：可以主界面是月份日历，放大后是每天的todolist，可选择周模式，天模式，左右活动分别选择月、周、日；日程表提供多种版本：健康型、学霸型、舒适型等；  
2015/12/25 甘少聪、牛严补充：todolist支持当前开始的三个月，之前的都归档，分为已完成、未完成、所有，每个月、周进行总结；    
...
* 
情绪能量补充，如休息时间推送优秀的音乐、段落（可选），或者其他自定方式  
* 
